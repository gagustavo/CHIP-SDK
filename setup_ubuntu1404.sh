...
git clone http://github.com/gagustavo/chip-mtd-utils
...
git clone https://github.com/gagustavo/CHIP-tools.git

echo -e "\n Installing CHIP-buildroot"
if [ ! -d CHIP-buildroot ]; then
  git clone http://github.com/gagustavo/CHIP-buildroot
else
